...
在Insert那里还有很多效果，最喜欢的是\@Citation，这简直是写期刊和论文的利器

![](2.jpeg)

参考文献支持Pubmed搜索关键词，连打开网站都省了，速度还挺快，比Endnote好

![](6.jpeg)

还支持输入DOI直接搜索期刊，自动生成参考文献。

![](4.jpeg)

当然还支持开源的**Zotero**，可以直接加载本地的库插入参考文献，当然在线的也可以

Zotero也是开源的软件，和R一样都是免费的东西，不用盗版，也不用破解。。。
